 ...
 * supported: "revolt", and "system". Defaults to "revolt" if none is specified. Note that there is no namespace on this attribute.
 * </ul>
 * <p/>
...
public class BaseSetting extends LinearLayout {
    ...
    /**
     * @return the table which the setting will be saved to. Currently only 'revolt' and 'system' are supported
     */
