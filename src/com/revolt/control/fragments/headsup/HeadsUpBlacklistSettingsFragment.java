...
public class HeadsUpBlacklistSettingsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        appsPackageList = Settings.REVOLT.getArrayList(mContext.getContentResolver(),
                Settings.REVOLT.HEADS_UP_BLACKLIST_VALUES);
                        ...
                        new SwipeDismissListViewTouchListener.DismissCallbacks() {
                            ...
                            public void onDismiss(ListView listView, int[] reverseSortedPositions) {
                                ...
                                Settings.REVOLT.putArrayList(mContext.getContentResolver(),
                                        Settings.REVOLT.HEADS_UP_BLACKLIST_VALUES, appsPackageList);
                            }
                        });
            ...
            switch (requestCode) {
                case ShortcutPickerHelper.REQUEST_PICK_APPLICATION:
                    ...
                    if (!appsPackageList.contains(packageName)) {
                        ...
                        Settings.REVOLT.putArrayList(mContext.getContentResolver(), Settings.REVOLT.HEADS_UP_BLACKLIST_VALUES, appsPackageList);
                        mArrayAdapter.notifyDataSetChanged();
                        break;
                    }
            }
