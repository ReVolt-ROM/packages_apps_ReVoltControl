...
import com.revolt.control.widgets.ActiveSeekPreference;

public class GestureAnywhereSettings extends ReVoltPreferenceFragment implements
    ...
    private ActiveSeekPreference mTriggerWidthPref;
    private ActiveSeekPreference mTriggerTopPref;
    private ActiveSeekPreference mTriggerBottomPref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTriggerWidthPref = (ActiveSeekPreference) findPreference(KEY_TRIGGER_WIDTH);
        ...
        mTriggerTopPref = (ActiveSeekPreference) findPreference(KEY_TRIGGER_TOP);
        ...
        mTriggerBottomPref = (ActiveSeekPreference) findPreference(KEY_TRIGGER_BOTTOM);
