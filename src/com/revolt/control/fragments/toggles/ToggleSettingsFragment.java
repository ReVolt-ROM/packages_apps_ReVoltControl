...
import com.revolt.control.settings.MultiChoiceSetting;
                ...
                if (cursor != null) {
                    try {
                        if (cursor.moveToFirst()) {
                            ...
                            Settings.REVOLT.putString(getActivity().getContentResolver(),
                                    Settings.REVOLT.QUICK_TOGGLE_FAV_CONTACT, lookup_key);
                        }
                    } finally {
                        cursor.close();
                    }
