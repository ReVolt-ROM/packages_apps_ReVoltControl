...
public class HorizontalRibbonSettings extends Fragment implements OnSeekBarChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedinstanceState) {
        ...
        mRibbonSize.setProgress(Settings.REVOLT.getInt(mContext.getContentResolver(), SETTINGS_REVOLT[AokpRibbonHelper.HORIZONTAL_RIBBON_SIZE], 30));
    ...
    public void onStopTrackingTouch(SeekBar seekBar) {
        if (seekBar == mRibbonSize) {
            Settings.REVOLT.putInt(mContext.getContentResolver(), SETTINGS_REVOLT[AokpRibbonHelper.HORIZONTAL_RIBBON_SIZE], mSeekBarProgress);
        }
    }
}
