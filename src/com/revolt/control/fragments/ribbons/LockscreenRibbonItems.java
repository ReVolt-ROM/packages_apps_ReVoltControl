...
public class LockscreenRibbonItems extends Fragment implements ShortcutPickerHelper.OnPickListener,
    ...
    String[] SETTINGS_REVOLT = Settings.REVOLT.AOKP_LOCKSCREEN_RIBBON;
    ...
    private void saveRibbons(ArrayList<RibbonItem> ribbonItems) {
        ...
        Settings.REVOLT.putArrayList(mContext.getContentResolver(),
                SETTINGS_REVOLT[AokpRibbonHelper.HORIZONTAL_RIBBON_ITEMS], saveList);
        updateRibbonList();
        mAdapter.notifyDataSetChanged();
    }
    ...
    private ArrayList<RibbonItem> getRibbons() {
        ...
        ArrayList<String> joinedList = Settings.REVOLT.getArrayList(mContext.getContentResolver(),
                SETTINGS_REVOLT[AokpRibbonHelper.HORIZONTAL_RIBBON_ITEMS]);
